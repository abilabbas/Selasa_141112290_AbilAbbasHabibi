...
namespace volleyball_problem
{
    public partial class Form1 : Form
    {
        ...
        static bool Valid(int merah, int biru)
        {
            if (merah < 25)
            {
                return false;
        ...
        {
            int merah = Convert.ToInt32(Txt1.Text);
            int biru = Convert.ToInt32(Txt2.Text);
            int res;
            if (merah < biru)
            {
                Swap(ref merah, ref biru);
            }
            ...
            else
            {
                ...
                {
                    res = nCr(24, 24, Mod);
                    res = (int)((((long)res) * ModolusPow(2, biru - 24, Mod)) % Mod);
                }
                else
                {
                    res = nCr(merah - 1, biru, Mod);
                }
